...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($errors)) {
        ...
        if ($sisa_hutang_baru <= 0) {
            $sisa_hutang_baru = 0;
            $status_baru = "lunas";
            $tanggal_lunas_sql = "CURDATE()";
        } else {
            $status_baru = "aktif";
            $tanggal_lunas_sql = "NULL";
        }
        ...
        $update = $pdo->prepare("
            ...
            SET
                ...
                status = :status,
                tanggal_lunas = $tanggal_lunas_sql,
                keterangan = :keterangan
            WHERE id_hutang = :id_hutang
        ");

        $update->execute([
            ":jumlah_terbayar" => $jumlah_terbayar_baru,
...
<head>
    ...
    <title>Edit Hutang - Ca'lontong</title>
    ...
    <main class="page-wrapper">
        <section class="debt-section">
            ...
            <div class="page-title-row">
                ...
                <h4 class="page-title mb-0">Edit Hutang Kasbon</h4>
            </div>
